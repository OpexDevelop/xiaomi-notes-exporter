...
const dict = {
    ru: {
        ...
        infoCli: "Если данных слишком много или требуется автоматизация, доступна <a href='https://github.com/OpexDevelop/xiaomi-notes-exporter' target='_blank'>CLI-версия на GitHub</a>.",
    ...
    en: {
        ...
        infoCli: "If there is too much data or automation is needed, a <a href='https://github.com/OpexDevelop/xiaomi-notes-exporter' target='_blank'>CLI version is available on GitHub</a>.",
